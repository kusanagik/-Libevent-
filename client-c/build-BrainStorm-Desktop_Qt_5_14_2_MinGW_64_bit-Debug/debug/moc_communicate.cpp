...
#include <memory>
#include "../../BrainStorm/communicate.h"
...
QT_MOC_LITERAL(5, 34, 18), // "recvSingleQuestion"
QT_MOC_LITERAL(6, 53, 4), // "rank"
QT_MOC_LITERAL(7, 58, 8) // "readData"

    },
    "Communicate\0rstResult\0\0login\0json\0"
    "recvSingleQuestion\0rank\0readData"
};
...
void Communicate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Communicate::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Communicate::rstResult)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Communicate::*)(QJsonObject );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Communicate::login)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Communicate::*)(QJsonObject );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Communicate::recvSingleQuestion)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Communicate::*)(QJsonObject );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Communicate::rank)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Communicate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Communicate.data,
    qt_meta_data_Communicate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 2
void Communicate::recvSingleQuestion(QJsonObject _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
